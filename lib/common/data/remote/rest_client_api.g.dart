...
class _RestClientApi implements RestClientApi {
  _RestClientApi(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<User> updateUserProfile(
    String userId,
    EditProfilRequest profilRequest,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = profilRequest;
    final _options = _setStreamType<User>(
      Options(method: 'PATCH', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  Future<ContactResponseEntity> getContacts() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ContactResponseEntity>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'v1/users/contacts',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ContactResponseEntity _value;
    try {
      _value = ContactResponseEntity.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<PostCreateResponse> createPost(
    ...
    final _options = _setStreamType<PostCreateResponse>(
      Options(
        method: 'POST',
        headers: _headers,
        extra: _extra,
  ...
  Future<User> updateProfilePicture(
    ...
    final _headers = <String, dynamic>{};
    final _data = FormData();
    _data.fields.add(MapEntry('userId', title));
    if (media != null) {
      _data.files.addAll(media.map((i) => MapEntry('media', i)));
    }
    final _options = _setStreamType<User>(
  ...
  @override
  Future<Post> addComment(String postId, CreateCommentRequest content) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = content;
  ...
  Future<BaseResponseEntity> bindFcmToken(
    ...
    final _options = _setStreamType<BaseResponseEntity>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late BaseResponseEntity _value;
    try {
      _value = BaseResponseEntity.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<BaseResponseEntity> getRtcToken(CallTokenRequestEntity params) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<BaseResponseEntity> sendMessage(ChatRequestEntity params) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<BaseResponseEntity> uploadImage(File file) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = FormData();
  ...
  Future<SyncMessageResponseEntity> syncMessage(
    ...
    final _data = <String, dynamic>{};
    _data.addAll(params.toJson());
    final _options = _setStreamType<SyncMessageResponseEntity>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'api/sync_message',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late SyncMessageResponseEntity _value;
    try {
      _value = SyncMessageResponseEntity.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
